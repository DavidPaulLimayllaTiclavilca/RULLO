...
BEGIN
  ...
  WRITELN(' AYUDA ');
  WRITELN;
  WRITELN('· El juego consiste en obtener la suma de números, tanto de las filas como de las columnas que aparece en la última columna y en la fila que está encima de la tabla');
  WRITELN('· El número que seleccione tomará el valor de 0 en las sumas');
...
close(fich);
END; 
PROCEDURE JugarPartida(VAR fich:TFicheroPartidas; tablaF, tablaC: TTabla; VAR tablaF_Bis: TTabla; VAR tablaC_Bis: TTabla; dimension: integer; opcionPartida: char);
VAR
...
BEGIN
                ...
                InicializarTablaPartida(tablaF_Bis, tablaC_Bis, dimension);
                MostrarTabla(tablaF, tablaC, tablaF_Bis, tablaC_Bis, dimension);
                JugarPartida(fich, tablaF, tablaC, tablaF_Bis, tablaC_Bis, dimension, opcionPartida);
end;
...
BEGIN
  RANDOMIZE;
  ASSIGN(fich,'C:\Users\alumno\Desktop\Partidas.bin');
